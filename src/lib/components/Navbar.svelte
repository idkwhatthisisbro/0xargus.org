...
<nav class="mx-auto hidden h-[72px] w-full max-w-7xl items-center justify-between bg-brand-bgPrimary px-[30px] md:flex">
	<a aria-label="home" href={BASE_URL} class="flex w-16 items-center gap-4">
	...
	<div class="hidden w-full items-center justify-center gap-x-12 md:flex">
		...
		<a aria-label="about" href={BASE_URL + '#about'} class="hidden font-outfit text-lg font-medium text-white duration-200 ease-in-out hover:text-neutral-300 lg:block">About</a>
		<a aria-label="features" href={BASE_URL + '#features'} class="hidden font-outfit text-lg font-medium text-white duration-200 ease-in-out hover:text-neutral-300 lg:block">Features</a>
		<a aria-label="how it works" href={BASE_URL + '#howitworks'} class="font-outfit text-lg font-medium text-white duration-200 ease-in-out hover:text-neutral-300">How it works</a>
		<a aria-label="faq" href={BASE_URL + '#faq'} class="font-outfit text-lg font-medium text-white duration-200 ease-in-out hover:text-neutral-300">FAQ</a>
	</div>

	<div class="hidden items-center gap-x-8 md:flex">
		<div class="flex items-center gap-x-4">
			<a aria-label="telegram" class="h-8 w-8 fill-neutral-300 duration-200 ease-in-out hover:fill-neutral-400" target="_blank" href="https://t.me/argusorg">
				<IconTelegram />
			</a>
			<a aria-label="x" class="h-8 w-8 fill-neutral-300 duration-200 ease-in-out hover:fill-neutral-400" target="_blank" href="https://x.com/0xArgusOrg">
				<IconX />
			</a>
		</div>
		<button
...
<nav class="z-50 flex h-[74px] w-full items-center px-8 md:hidden">
	<div class="z-50 flex w-full items-center justify-between">
		<a aria-label="home" href={BASE_URL} class="flex w-10 items-center gap-4">
