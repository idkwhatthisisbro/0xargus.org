...
<svg
	...
	stroke-width="7"
	width="56"
	class={'min-h-12 min-w-12 cursor-pointer rounded-full stroke-neutral-100 p-2 duration-500  ease-in-out hover:bg-white/10 hover:text-indigo-500'}>
