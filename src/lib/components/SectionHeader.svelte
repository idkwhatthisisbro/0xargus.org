...
<section class={cn('mt-20 grid items-center justify-center gap-6 py-8 sm:py-32' + className)}>
	...
	<div class="grid items-center justify-center text-center">
		<h3 class="z-[98] m-auto max-w-xl bg-gradient-to-b from-purple-500 via-purple-600 to-indigo-500 bg-clip-text font-outfit text-4xl font-bold leading-snug text-transparent sm:text-6xl">
