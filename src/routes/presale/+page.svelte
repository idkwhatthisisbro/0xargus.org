<script lang="ts">
	...
	const smth = 'neatt';
	const somethingElse = smth + ' thing';
	...
	const data = [
		...
		},
		{
			...
			objective:
				'Objective: Thoroughly test the product in a real-world environment and iterate based on user feedback.',
			details: [
		...
		},
		{
			...
			objective:
				'Objective: Reward early supporters with staking capabilities while maintaining market stability.',
			details: [
		...
		{
			title: 'Revenue Sharing Platform Goes Live',
			objective:
				'Objective: Launch the main feature of the platform, enabling token holders to directly benefit from its success.',
			details: [
	...
	<main
		...
		<div
			...
			<div
				...
				<h1
					class="font-regular text-6xl text-white">
					Genesis Founders Presale
				</h1>
				<h2
					class="text-2xl font-light text-gray-100">
					MAY 04, 2024 3PM UTC
				</h2>
			</div>
			...
			<Countdown
				...
				let:remaining>
				<div
					class="flex gap-10 text-2xl text-white">
					{#if remaining.done === false}
						<span
							class="flex flex-col items-center justify-center gap-2">
							<span
								class="text-6xl font-bold text-violet-200"
								>{remaining.totalDays}</span>
							<span
								class="font-regular text-2xl text-gray-500"
								>Days</span>
						</span>
		...
		<div
			class="relative grid w-full auto-rows-auto grid-cols-3 gap-4 px-8">
			<!-- PRESALE CARD -->
			<div
			...
			<div
				...
				<div
					...
					<p
						class="text-center text-2xl text-white/80">
						Depending on your, holding Argus
						yields you. No transaction fees <br />
						when using the product, to revenue share
						and DAO votes.
					</p>
				</div>
				<img
					src="/tg-welcomeBanner.gif"
					class="w-[560px] rounded-md"
					alt="" />
				<span
					class="absolute h-1/4 w-2/4 bg-gradient-to-r from-[#93C5FD] via-[#5A9AF8] to-[#3B82F6] opacity-30 blur-[400px]" />
			</div>
			...
			<div
				...
				<div class="flex flex-col gap-3">
					<div class="flex items-center gap-2">
						...
						<h2
							class="text-2xl font-semibold text-white">
							About The Token Launch
						</h2>
					</div>
					<p class="text-white/80">
						Users registered for the token sale
						will receive an email with a unique
						link to enter the queue prior to the
						start of the sale. After the sale
						starts, users who are already in the
						waiting room will be given a random
						place in line, ahead of those who
						arrive after the sale starts. Users
						arriving after the sale starts get a
						first-come, first-served place in line
						after those in the waiting room.
					</p>
				</div>
				<span
					class="absolute h-1/4 w-2/4 bg-gradient-to-r from-[#93C5FD] via-[#5A9AF8] to-[#3B82F6] opacity-30 blur-[100px]" />
		...
		<div class="flex flex-col gap-16">
			...
			<div>
				...
				<ul class="list-disc text-white/80">
					<li>
						$ARGUS is a deflationary currency with
						a 1B supply cap. This cap fosters
						scarcity and value appreciation over
						time.
					</li>
					<li>
						All token holders can stake to receive
						their proportional fraction of the
						platform’s revenue, with no lockup or
						bonding required to do so. This model
						grants freedom and liquidity, allowing
						all participants to benefit from the
						ecosystem’s success proportionally to
						their token holdings.
					</li>
					<li>
						The initial distribution at launch is
						1,000,000,000 $ARGUS tokens, subject
						to various lockup schedules.
					</li>
				</ul>
			</div>
			...
			<div class="flex flex-col gap-36">
				...
				<div class="flex flex-col gap-10">
					...
					<p class="text-white/80">
						...
						percentages. It helps stakeholders
						quickly grasp how tokens are divided
						and the proportion each category
						holds.
					</p>
				</div>
				...
				<div class="flex flex-col gap-10">
					...
					<p class="text-white/80">
						This table details the lockup periods
						and release schedules. This provides a
						concise reference for investors and
						stakeholders to understand when
						different portions of tokens will
						become liquid and enter circulation,
						facilitating better investment and
						strategic decisions.
					</p>
				</div>
				...
				<div class="flex flex-col gap-10">
					...
					<p class="text-white/80">
						This diagram depicts the cumulative
						circulating supply of tokens over
						time, from launch through to month 36.
						It tracks the increase in circulating
						tokens as they are released from
						lockup periods, according to the
						schedules detailed in the Token Lockup
						Periods table.
					</p>
				</div>
				...
				<div
					...
					<p class="text-white/80">
						...
						Initial Distribution unlocks over
						time, some portions do not. In order
						to foster a high staking ratio and
						orderly markets, 0xArgus had been
						designed to provide Supercharged
						Rewards to Genesis Founding Members
						and Public Presale participants that
						stake their unlocked tokens throughout
						the full duration of their vesting
						period.
					</p>
				</div>
			</div>
